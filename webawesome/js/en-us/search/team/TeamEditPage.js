Promise.all([
    ...
    , customElements.whenDefined('wa-dropdown')
          ...
          // PATCH region
          document.querySelector('#Page_region')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#Page_region')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_region')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_region');
            const valid = form.reportValidity();
          });
          ...
          // PATCH teamId
          document.querySelector('#Page_teamId')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#Page_teamId')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_teamId')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_teamId');
            const valid = form.reportValidity();
          });
});
