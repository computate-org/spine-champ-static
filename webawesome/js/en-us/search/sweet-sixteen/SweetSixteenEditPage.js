Promise.all([
    ...
    , customElements.whenDefined('wa-dropdown')
          ...
          // PATCH year
          document.querySelector('#Page_year')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#Page_year')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_year')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_year');
            const valid = form.reportValidity();
          });
          ...
          // PATCH bracketId
          document.querySelector('#Page_bracketId')?.addEventListener('change', (event) => {
          ...
          document.querySelector('#Page_bracketId')?.addEventListener('focus', (event) => {
            removeGlow(event.currentTarget);
          });
          document.querySelector('#Page_bracketId')?.addEventListener('blur', (event) => {
            const form = document.querySelector('#PageForm_bracketId');
            const valid = form.reportValidity();
          });
